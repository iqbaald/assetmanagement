    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar"> 
            <div class="nav-item d-flex gap-1 gap-sm-3 align-self-end">
                <a href="#" target="_blank" class="btx btx-primary active mb-0" role="button" aria-pressed="true">
                ...
                <a href="#" target="_blank" class="btx btx-trans mb-0" role="button" aria-pressed="true">
